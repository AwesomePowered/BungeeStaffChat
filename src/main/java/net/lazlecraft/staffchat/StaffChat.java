...
public class StaffChat extends ConfigurablePlugin {
	
	public String Prefix = ChatColor.GOLD + "[" + ChatColor.GREEN + "StaffChat" + ChatColor.GOLD + "] ";
	...
	public void registerFeature() {
		if (ProxyServer.getInstance().getConfigurationAdapter().getBoolean("online_mode",true)) {
			this.getProxy().getPluginManager().registerCommand(this, new sc(this));
